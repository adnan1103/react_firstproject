                ...
                <Grid item>
                    <Grid container direction="column">
                        <Grid item >
                            ...
                            <Typography variant="body1" align={matchesMD ? "center" : undefined} style={{ color: theme.palette.common.blue }}> We are waiting.</Typography>
                        </Grid>
                        ...
                        <Grid item container >
                            ...
                            <Grid item>
                                <Typography variant="body1" style={{ color: theme.palette.common.blue, fontSize: "1rem" }}>
                                    <a href="mailto:adnan@gmail.com" style={{ textDecoration: "none", color: 'inherit' }}>adnan@gmail.com</a>
                                </Typography>
                            </Grid>
                        </Grid>
                        ...
                        <Grid item container justify="center" style={{ maxWidth: "20em", marginTop: "2em" }}>
